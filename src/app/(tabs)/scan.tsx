...
function getStageCopy(stage: ScanStage): {
  ...
  switch (stage) {
    ...
    case "done":
      return {
        title: "Done",
        message: "Scan saved locally. Ready for the next sheet.",
      };
...
export default function ScanScreen() {
  ...
  const handleCapture = async () => {
    ...
    try {
       ...
       * ------------------------------------------------------------------------
       *
       * No success Alert and no Continue button.
       * Show a short Done state, then automatically return to the live camera.
       */
